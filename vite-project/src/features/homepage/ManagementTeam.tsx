  ...
  return (
    <>
      ...
      <div className="lg:flex justify-center text-center items-center gap-10 md:flex sm:w-full sm:h-full">
        <>
          <Card placeholder="" className="lg:w-96 md:w-96">
            <CardHeader placeholder="" floated={false} className="2xl:h-80">
              <img
        ...
        <>
          <Card placeholder="" className="lg:w-96">
            <CardHeader placeholder="" floated={false} className="2xl:h-80">
              <img
                src="https://docs.material-tailwind.com/img/team-3.jpg"
                alt="profile-picture"
      ...
      <div className="lg:flex justify-center text-center items-center p-4">
        <Button placeholder="" color="green">
          Show More
        </Button>
      </div>
    </>
